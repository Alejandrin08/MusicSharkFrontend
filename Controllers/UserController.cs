...
public class UserController(UserClientService users, RoleClientService roles) : Controller
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync(UserPwd itemToCreate)
    {
    ...
    private async Task RolesDropDownListAsync(object? rolSeleccionado = null)
    {
        ...
        ViewBag.Role = new SelectList(list, "Name", "Name", rolSeleccionado);
    }
}